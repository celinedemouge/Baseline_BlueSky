### Useful functions and data for flight data creation


def to_decimal(d, m, s):
    """ From a degree,minutes,seconds latitude/longitude to a decimal one"""
...
# List of RWY at Barcelona airport
RWY = ["25R", "25L", "07R", "07L", "02"]


# IAF corresponding to entry WP
WP_IAF = {
...
def get_IAF(rwy, wp):
    """ Returns the IAF according to the RWY and the entry WP."""
    iaf = ""
    if rwy in ["25R", "25L"]:
        iaf = WP_IAF[wp][0]
        print(iaf)
